...
from verl_old.trainer.ppo.core_algos import agg_loss, compute_policy_loss, kl_penalty
from verl_old.utils.debug import GPUMemoryLogger
from verl_old.utils.debug.profile import Profiler
...
from verl_old.utils.megatron_utils import get_model_config
...
class MegatronPPOActor(BasePPOActor):
    ...
    def forward_backward_batch(self, data: DataProto, forward_only=False, post_process_fn=None, calculate_entropy=False, use_dynamic_bsz=False, micro_batch_size=None, max_token_len=None, mini_batch_size=None):
        ...
        def forward_step(batch_iter, model):
            ...
            from verl_old.models.mcore import get_mcore_forward_fn
