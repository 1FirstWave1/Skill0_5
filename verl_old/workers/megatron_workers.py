...
from verl_old.single_controller.base.decorator import Dispatch, register
from verl_old.single_controller.base.megatron.worker import MegatronWorker
...
from verl_old.utils.debug import GPUMemoryLogger, log_gpu_memory_usage
...
from verl_old.utils.model import load_mcore_dist_weights, load_megatron_gptmodel_weights
from verl_old.workers.actor.megatron_actor import MegatronPPOActor
from verl_old.workers.critic.megatron_critic import MegatronPPOCritic
from verl_old.workers.reward_model.megatron.reward_model import MegatronRewardModel
...
class ActorRolloutRefWorker(MegatronWorker):
    ...
    def _build_model_optimizer(self, model_path, optim_config, override_model_config, override_transformer_config):
        ...
        from verl_old.utils.megatron.optimizer import get_megatron_optimizer
        from verl_old.utils.megatron_utils import get_model, init_megatron_optim_config
        from verl_old.utils.model import get_generation_config, print_model_size
    ...
    def _build_rollout(self, trust_remote_code=False):
        ...
        if self.config.rollout.name == "vllm":
            ...
            from verl_old.workers.rollout.vllm_rollout import vllm_mode, vLLMRollout
            from verl_old.workers.sharding_manager.megatron_vllm import MegatronVLLMShardingManager
            ...
            from verl_old.workers.rollout.sglang_rollout import SGLangRollout
            ...
            from verl_old.workers.sharding_manager.megatron_sglang import MegatronSGLangShardingManager
...
class RewardModelWorker(MegatronWorker):
    ...
    def _build_rm_model(self, model_path, override_model_config, override_transformer_config):
        ...
        from verl_old.utils.megatron_utils import get_model
