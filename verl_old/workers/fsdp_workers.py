...
from verl_old.utils.py_functional import convert_to_regular_types
...
from verl_old.utils.activation_offload import enable_activation_offloading
...
class ActorRolloutRefWorker(Worker):
    ...
    def _build_model_optimizer(
        ...
        from verl_old.utils.model import get_generation_config, print_model_size, update_model_config
        ...
        if role == "actor" and optim_config is not None:
            from verl_old.utils.torch_functional import get_constant_schedule_with_warmup, get_cosine_schedule_with_warmup
    ...
    def _build_rollout(self, trust_remote_code=False):
        ...
        if rollout_name == "hf":
            from verl_old.workers.rollout import HFRollout
            from verl_old.workers.sharding_manager.base import BaseShardingManager
            ...
            from verl_old.workers.sharding_manager.fsdp_vllm import FSDPVLLMShardingManager
            ...
            from verl_old.workers.sharding_manager.fsdp_sglang import FSDPSGLangShardingManager
    ...
    def init_model(self):
        from verl_old.workers.actor import DataParallelPPOActor
...
class CriticWorker(Worker):
    ...
    def init_model(self):
        ...
        from verl_old.workers.critic import DataParallelPPOCritic
...
class RewardModelWorker(Worker):
    ...
    def _forward_micro_batch(self, micro_batch):
        ...
        from verl_old.utils.ulysses import gather_outpus_and_unpad, ulysses_pad_and_slice_inputs
