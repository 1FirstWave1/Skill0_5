...
from verl_old.models.mcore.weight_converter import McoreToHFWeightConverterBase
...
from verl_old.utils.memory_buffer import (
    build_memory_buffer,
...
from verl_old.utils.vllm_utils import patch_vllm_moe_model_weight_loader
...
Consider using the `MegatronPPOActor` class directly as a replacement."
    ...
    def _build_param_buffer(self, pp_rank):
        ...
        if pp_rank == self._pp_rank:
            from verl_old.utils.memory_buffer import MemoryBuffer
