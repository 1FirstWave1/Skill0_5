...
from verl_old.utils.device import get_device_name, get_nccl_backend, get_torch_device
...
from verl_old.utils.tokenizer import hf_processor, hf_tokenizer
...
class MegatronModelMerger(BaseModelMerger):
    ...
    def merge_and_save(self):
        from verl_old.utils.megatron_utils import get_dist_checkpoint_path
