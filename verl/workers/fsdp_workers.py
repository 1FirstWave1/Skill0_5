...
from verl_old.utils.model import compute_position_id_with_mask, convert_weight_keys
...
class CriticWorker(Worker, DistProfilerExtension):
    ...
    def _build_critic_model_optimizer(self, config):
        ...
        from verl_old.utils.model import load_valuehead_model, print_model_size
        from verl_old.utils.torch_dtypes import PrecisionType
...
class RewardModelWorker(Worker, DistProfilerExtension):
    ...
    def _forward_micro_batch(self, micro_batch):
        ...
        from verl_old.utils.ulysses import gather_outputs_and_unpad, ulysses_pad_and_slice_inputs
