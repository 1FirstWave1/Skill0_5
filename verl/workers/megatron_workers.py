...
from verl_old.utils.distributed import set_numa_affinity
...
from verl_old.utils.model import get_hf_model_path, load_mcore_dist_weights, load_megatron_gptmodel_weights
...
from verl_old.utils.torch_functional import use_original_torch_compile
...
from verl_old.workers.rollout import get_rollout_class
...
class MegatronWorker(Worker):
    def _init_hf_config_and_tf_config(
        ...
        from verl_old.models.mcore import hf_to_mcore_config
        from verl_old.utils import hf_processor, hf_tokenizer
        from verl_old.utils.fs import copy_to_local
        from verl_old.utils.model import update_model_config
        ...
        from verl_old.models.mcore.config_converter import mapping_string_to_attn_backend
...
class ActorRolloutRefWorker(MegatronWorker, DistProfilerExtension):
    ...
    def _build_model_optimizer(
        ...
        from verl_old.utils.megatron_utils import McoreModuleWrapperConfig, make_megatron_module
