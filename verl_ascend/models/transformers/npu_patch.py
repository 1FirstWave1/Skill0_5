...
def _optional_import(module_name):
    try:
        ...
        logger.warning("Skip Ascend NPU patch for %s: %s", module_name, exc)
        return None


modeling_qwen2 = _optional_import("transformers.models.qwen2.modeling_qwen2")
modeling_qwen2_5_vl = _optional_import("transformers.models.qwen2_5_vl.modeling_qwen2_5_vl")
modeling_qwen3 = _optional_import("transformers.models.qwen3.modeling_qwen3")
modeling_qwen3_moe = _optional_import("transformers.models.qwen3_moe.modeling_qwen3_moe")
modeling_qwen3_vl = _optional_import("transformers.models.qwen3_vl.modeling_qwen3_vl")
modeling_qwen3_vl_moe = _optional_import("transformers.models.qwen3_vl_moe.modeling_qwen3_vl_moe")
...
if modeling_qwen2_5_vl is not None:
...
if modeling_qwen3_moe is not None:
...
if modeling_qwen3_vl is not None:
...
if modeling_qwen3_vl_moe is not None:
