...
class BaseCheckpointManager:
    ...
    def __init__(
        ...
        checkpoint_contents: list[str] = None,
    ):
        ...
        if checkpoint_contents is not None:
            checkpoint_load_contents = checkpoint_load_contents or checkpoint_contents
            checkpoint_save_contents = checkpoint_save_contents or checkpoint_contents
        ...
        self.checkpoint_contents = checkpoint_save_contents
